...
function DataReagen (){
    const Data = [
        ...
        },
        {
            ...
            "bentuk":"Cair",
            "stock":"51",
            "parameter":"[Hemoglobin], [WBC], [Trombosit], [Feses Rutin]",
        },
        {
            "id":3,
            "kode":"REA-003",
    ...
    return (
        <div className=" p-8">
            <div className='tex-center items-center mt-4 mb-10'>
                <h1 className='font-bold text-2xl text-info text-center '>Data Reagen</h1>
            </div>
                    ...
                    <tbody>
                        {Data.map((item) => (
                            <tr>
                                ...
                                <td className="text-center">{item.bentuk}</td>
                                <td className="text-center">{item.stock}</td>
                                <td className="text-center">{item.parameter}</td>
                                <td className="flex justify-center">
                                    <div className="flex">
                                        <button className="btn btn-success mr-1" style={{color:"white"}}><BsFillPinAngleFill /></button>
                                        <button className="btn btn-warning mr-1" style={{color:"white"}}><FaPlus /></button>
                                        <button className="btn btn-info mr-1" style={{color:"white"}}><FaPencilAlt /></button>
                                        <button className="btn btn-error"><GrClose /></button>
                                    </div>
                                </td>
                            </tr>
                        ))}
