    ...
    return (
        <div className=" p-8">
            <div className='tex-center items-center mt-4 mb-10'>
                <h1 className='font-bold text-2xl text-info text-center '>Kelompok Parameter Uji</h1>
            </div>
                ...
                <table class="table w-full">
                    <thead>
                        <tr>
                            ...
                            <th className="text-center">Nama Kelompok</th>
